...
def save_one_box(xyxy, im, file='image.jpg', gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    #save to a fixed size 400*300

    # if int(xyxy[0, 2])>=400 or int(xyxy[0, 0])<=1808:
    #     if int(xyxy[0, 1])>=300 or int(xyxy[0, 3])<=942:
    #
    # elif int(xyxy[0, 2])<=400:
    #     pass
    # elif int(xyxy[0, 2])>=1808:
    #     pass
    ...
    new_xyxy=[int((x2+x0)/2-200),int((y3+y1)/2-150),int((x2+x0)/2+200),int((y3+y1)/2+150)]
    if new_xyxy[0]<0:
        new_xyxy[0] = 0
        new_xyxy[2] = 400
    if new_xyxy[1]<0:
    ...
    crop = im[new_xyxy[1]:new_xyxy[3], new_xyxy[0]:new_xyxy[2], ::(1 if BGR else -1)]
    if save:
